...
function Footer() {
    ...
    return (
        <footer className={cx('footer')}>
                        ...
                        <div className={cx('coppy_right')}>
                            <div>
                                ...
                                <span className={cx('text')}>
                                    {' '}
                                    Công ty Cổ Phần Tlove - ĐKKD: 037 181818 do sở Phú Yên cấp lần đầu
                                    ngày 18/10/2023
                                </span>
                            </div>
                            <div>
                                ...
                                <span className={cx('text')}>
                                    {' '}
                                    D_8D_CN Đường XE 1, Khu Công Nghiệp Mỹ Phước III, phường Mỹ Phước, thị xã Hòa Định Tây,
                            ...
                            <div>
                                ...
                                <span className={cx('text')}>
                                    {' '}
                                    Phòng 702, Tầng 7, Tòa nhà Central Plaza, số 18 Trần Quốc Tuấn, phường Gấu Trúc, quận 1, Phú Yên
                            ...
                            <div>
                                ...
                                <span className={cx('text')}> 1900 1818 212 (Ext.9100/ 9102)</span>
                            </div>
                            <div>
                                <span className={cx('title')}> Fax:</span>
                                <span className={cx('text')}>
                                    {' '}
                                    (037) 1821 1821 Email: pkAn@Tlove.pandagroup.com 
                                </span>
                            </div>
                        </div>
                    </Grid>
            ...
            <div className={cx('cpright')}>© 2023 Bản quyền by Tlove_Panda</div>
        </footer>
    );
}
