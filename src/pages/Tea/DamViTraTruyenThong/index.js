            ...
            <div className={cx('content')}>
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    ...
                    <Grid item xs={12} md={6}>
                        <div className={cx('item')}>
                            <p className={cx('text')}>
                                Trong quá trình tìm kiếm từng loại trà thượng hạng, Tlove luôn giữ gìn những hợp
                            ...
                            <p className={cx('text')}>
                                Tlove thấu hiểu để có được một tách trà ngon thì từ quá trình thu hái lá trà cho đến
